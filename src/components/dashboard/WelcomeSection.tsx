...
const WelcomeSection: React.FC<WelcomeSectionProps> = ({ period, setPeriod }) => {
  return (
    <div className="flex items-center justify-between mb-10 animate-fade-in">
      <div>
        <h2 className="text-4xl font-bold text-slate-900 dark:text-slate-100 mb-3 font-ny">Welcome back, Wilson!</h2>
        <p className="text-slate-600 dark:text-slate-300 text-lg font-sf-pro">Here's what's happening with your business today.</p>
      </div>
