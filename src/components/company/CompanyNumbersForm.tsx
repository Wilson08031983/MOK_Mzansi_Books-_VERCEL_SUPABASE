    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div>
        ...
        {isEditing ? (
          ...
          <p className="px-4 py-3 bg-white/5 dark:bg-black/20 border border-white/10 rounded-xl font-sf-pro text-foreground">{companyData.regNumber}</p>
        )}
      </div>
      <div>
        ...
        {isEditing ? (
          <input
            ...
            className={`w-full px-4 py-3 glass backdrop-blur-md ${companyData.vatNumberNotApplicable ? 'bg-white/5 text-slate-500' : 'bg-white/10 dark:bg-black/30 text-foreground'} placeholder:text-slate-400 border border-white/10 rounded-xl focus:ring-2 focus:ring-mokm-purple-500/50 focus:border-mokm-purple-500/50 transition-all duration-300 font-sf-pro`}
          />
        ) : (
      ...
      <div>
        ...
        {isEditing ? (
          ...
          <p className="px-4 py-3 bg-white/5 dark:bg-black/20 border border-white/10 rounded-xl font-sf-pro text-foreground">{companyData.taxNumber}</p>
        )}
      </div>
      <div>
        <div className="flex justify-between items-center mb-2">
