...
const FounderSection = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-slate-100 mb-4 animate-fade-in">
            Meet Our Founder
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-orange-500 to-purple-600 mx-auto animate-scale-in delay-300"></div>
        </div>
        
        <div className="rounded-2xl shadow-business p-8 md:p-12 relative overflow-hidden animate-slide-up delay-500 bg-slate-900/60 border border-white/10 backdrop-blur-md">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl font-bold text-slate-100 mb-2">Wilson Mokgethwa Moabelo</h3>
              <p className="text-purple-300 font-semibold mb-6">Founder & CEO</p>
              
              <blockquote className="text-lg text-slate-400 leading-relaxed italic">
