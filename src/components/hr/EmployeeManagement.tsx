  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 font-sf-pro">Employee Management</h2>
          <p className="text-slate-600 dark:text-slate-400 font-sf-pro">Manage your company workforce</p>
        </div>
        ...
        <CardContent className="p-4">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            <div className="w-full md:w-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full md:w-64 pl-10 pr-4 py-2 glass backdrop-blur-sm bg-white dark:bg-black/30 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-slate-200 placeholder:text-slate-400 rounded-xl focus:ring-2 focus:ring-mokm-purple-500/40 focus:border-slate-300 dark:focus:border-white/20 transition-all duration-300 font-sf-pro"
                />
              </div>
            </div>
            ...
            <select
              ...
              className="px-3 py-2 glass backdrop-blur-sm bg-white dark:bg-black/30 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-slate-200 rounded-xl focus:ring-2 focus:ring-mokm-purple-500/40 focus:border-slate-300 dark:focus:border-white/20 transition-all duration-300 font-sf-pro text-sm"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {displayEmployees.length > 0 ? (
          displayEmployees.map(employee => (
            <Card key={employee.id} className="glass backdrop-blur-md bg-white dark:bg-black/30 border border-slate-200 dark:border-white/10 shadow-business hover:shadow-business-lg rounded-xl transition-all duration-300 overflow-hidden">
              <CardContent className="p-0">
                <div 
                  className="p-4 flex items-center justify-between cursor-pointer hover:bg-slate-50 dark:hover:bg-white/10 transition-colors"
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <div className="font-medium text-slate-900 dark:text-slate-100 font-sf-pro">{getFullName(employee)}</div>
                      <div className="text-sm text-slate-600 dark:text-slate-400 font-sf-pro">{employee.position || 'No position'}</div>
                    </div>
                  </div>
                  <span className={`px-2 py-1 text-xs rounded-full border border-slate-200 dark:border-white/10 font-sf-pro ${getStatusBadgeColor(employee.status || '')}`}>
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-white/5 border-t border-slate-200 dark:border-white/10">
                    <div className="grid grid-cols-1 gap-3">
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-xs text-slate-600 dark:text-slate-400 font-sf-pro">Email</div>
                          <div className="text-sm text-slate-900 dark:text-slate-100 font-sf-pro">{employee.email || 'Not provided'}</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-xs text-slate-600 dark:text-slate-400 font-sf-pro">Phone</div>
                          <div className="text-sm text-slate-900 dark:text-slate-100 font-sf-pro">{employee.contactNumber || 'N/A'}</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-xs text-slate-600 dark:text-slate-400 font-sf-pro">Department</div>
                          <div className="text-sm text-slate-900 dark:text-slate-100 font-sf-pro">{employee.department || 'Not assigned'}</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <div className="text-xs text-slate-600 dark:text-slate-400 font-sf-pro">Start Date</div>
                          <div className="text-sm text-slate-900 dark:text-slate-100 font-sf-pro">{formatDate(employee.startDate)}</div>
                        </div>
                      </div>
          ...
          <div className="col-span-full">
            <Card className="glass backdrop-blur-md bg-white dark:bg-black/30 border border-slate-200 dark:border-white/10 shadow-business rounded-xl">
              <CardContent className="text-center py-12">
                <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-r from-mokm-purple-500/30 to-mokm-blue-500/30 border border-white/10 flex items-center justify-center">
                  <UserPlus className="h-12 w-12 text-mokm-purple-400" />
                </div>
                <h3 className="mt-4 text-lg font-medium text-slate-900 dark:text-slate-100 font-sf-pro">No employees found</h3>
                <p className="mt-1 text-slate-600 dark:text-slate-400 font-sf-pro">
                  Add employees or adjust your filters to see employees
                </p>
                <div className="mt-6">
                  <Button 
                    className="bg-gradient-to-r from-mokm-blue-500 to-mokm-purple-500 hover:from-mokm-blue-600 hover:to-mokm-purple-600 text-white font-sf-pro"
                    onClick={() => setIsAddEmployeeModalOpen(true)}
                  >
