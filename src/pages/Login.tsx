      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="shadow-business-xl border-0 bg-white/90 backdrop-blur-md hover-lift animate-fade-in">
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              <CardTitle className="text-2xl font-bold text-gray-900 drop-shadow-sm">{t('auth.login.title')}</CardTitle>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-700 font-medium drop-shadow-sm">{t('auth.login.emailLabel')}</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-gray-700 font-medium drop-shadow-sm">{t('auth.login.passwordLabel')}</Label>
